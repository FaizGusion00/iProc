...
--
-- =====================================================
-- DATABASE STRUKTUR UNTUK REPOSITORY PUBLIC
-- =====================================================
-- NOTA: Fail ini TIDAK mengandungi data sebenar
-- Hanya struktur database untuk development/testing
-- =====================================================
...
-- NOTA: Guna data dummy untuk testing - TUKAR untuk production!
--

INSERT INTO `admin` (`ADMIN_CODE`, `ADMIN_NRIC`, `ADMIN_PASS`) VALUES
(1, '000000000000', 'TukarPassword123!');
...
INSERT INTO `ptj` (`PTJ_CODE`, `PTJ_NAME`, `PTJ_STATUS`, `PTJ_DATE`) VALUES
(5, 'Contoh PTJ 1', 1, '03:30  28-09-22'),
(6, 'Contoh PTJ 2', 1, '03:03  28-09-22');
...
-- NOTA: Data dummy untuk testing - GUNA DATA SEBENAR untuk production!
--
...
(19, '111111111111', 'PENGGUNA UJIAN 1', 'JAWATAN UJIAN', 'W19', 'test1@example.com', '0111111111', 5, 1, '03:30  28-09-22', 'TukarPassword123!'),
(20, '222222222222', 'PENGGUNA UJIAN 2', 'JAWATAN UJIAN', 'FA29', 'test2@example.com', '0122222222', 6, 1, '03:03  28-09-22', 'TukarPassword123!');
...
--
ALTER TABLE `latmajrasmi`
  MODIFY `LATMAJRASMI_CODE` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `roles`
  MODIFY `ROLE_CODE` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `ppt`
  ADD CONSTRAINT `ppt_ibfk_1` FOREIGN KEY (`PPT_LATMAJRASMI`) REFERENCES `latmajrasmi` (`LATMAJRASMI_CODE`),
  ADD CONSTRAINT `ppt_ibfk_2` FOREIGN KEY (`PPT_PROCCAT`) REFERENCES `proccat` (`PROCCAT_CODE`),
  ADD CONSTRAINT `ppt_ibfk_3` FOREIGN KEY (`PPT_PROCMETHOD`) REFERENCES `procmethod` (`PROCMETHOD_CODE`);
...
ALTER TABLE `usermatrix`
  ...
  ADD CONSTRAINT `usermatrix_ibfk_2` FOREIGN KEY (`ROLE_CODE`) REFERENCES `roles` (`ROLE_CODE`),
  ADD CONSTRAINT `usermatrix_ibfk_3` FOREIGN KEY (`PROCESS_CODE`) REFERENCES `processes` (`PROCESS_CODE`);
...
-- =====================================================
-- 1. Fail ini mengandungi data DUMMY untuk development
-- 2. JANGAN guna untuk production - data tidak sebenar
-- 3. Tukar semua password dan IC numbers untuk production
-- 4. Guna fail database/config.example.php sebagai template
-- ===================================================== 